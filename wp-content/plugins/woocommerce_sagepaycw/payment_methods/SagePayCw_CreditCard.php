...
class SagePayCw_CreditCard extends SagePayCw_PaymentMethod
{
	...
	protected function getMethodSettings(){
		return array(
			'credit_card_brands' => array(
				'title' => __("Credit Card Brands", 'woocommerce_sagepaycw'),
 				'default' => array(
					0 => 'visa',
 					1 => 'mastercard',
 					2 => 'americanexpress',
 				...
 				'description' => __("In case hidden authorization is used, the brand of the credit card is detected by the card number and the card number is validated accordingly. This setting enables the restriction of the allowed brands.", 'woocommerce_sagepaycw'),
 				'cwType' => 'multiselect',
 				'type' => 'multiselect',
 				'options' => array(
					'visa' => __("VISA", 'woocommerce_sagepaycw'),
 					'mastercard' => __("MasterCard", 'woocommerce_sagepaycw'),
 					'americanexpress' => __("American Express", 'woocommerce_sagepaycw'),
 					'diners' => __("Diners Club", 'woocommerce_sagepaycw'),
 					'jcb' => __("JCB", 'woocommerce_sagepaycw'),
 					'maestro' => __("Maestro", 'woocommerce_sagepaycw'),
 					'debitmastercard' => __("Debit MasterCard", 'woocommerce_sagepaycw'),
 					'debitvisa' => __("Debit Visa", 'woocommerce_sagepaycw'),
 					'visaelectron' => __("VISA Electron", 'woocommerce_sagepaycw'),
 					'laser' => __("Laser", 'woocommerce_sagepaycw'),
 				),
 			),
 			...
 			'authorizationMethod' => array(
				'title' => __("Authorization Method", 'woocommerce_sagepaycw'),
 				'default' => 'IframeAuthorization',
 				'description' => __("Select the authorization method to use for processing this payment method.", 'woocommerce_sagepaycw'),
 				'cwType' => 'select',
 				'type' => 'select',
 				'options' => array(
					'IframeAuthorization' => __("IFrame Authorization (Server with IFrame)", 'woocommerce_sagepaycw'),
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_sagepaycw_creditcard_icon', 
			SagePayCw_Util::getResourcesUrl('icons/creditcard.png')
		);
		parent::__construct();
	}
