...
class SagePayCw_LaserCard extends SagePayCw_PaymentMethod
{
	public $machineName = 'lasercard';
	public $admin_title = 'Laser Card';
	public $title = 'Laser Card';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_sagepaycw_lasercard_icon', 
			SagePayCw_Util::getResourcesUrl('icons/lasercard.png')
		);
		parent::__construct();
	}
