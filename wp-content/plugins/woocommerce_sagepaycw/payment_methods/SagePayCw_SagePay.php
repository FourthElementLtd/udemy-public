...
class SagePayCw_SagePay extends SagePayCw_PaymentMethod
{
	public $machineName = 'sagepay';
	public $admin_title = 'Opayo Payment';
	public $title = 'Opayo Payment';
			...
			'address_check_behavior' => array(
 			...
 			'authorizationMethod' => array(
				'title' => __("Authorization Method", 'woocommerce_sagepaycw'),
 				...
 				'type' => 'select',
 				'options' => array(
					'PaymentPage' => __("Payment Page (Server)", 'woocommerce_sagepaycw'),
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_sagepaycw_sagepay_icon', 
			SagePayCw_Util::getResourcesUrl('icons/sagepay.png')
		);
		parent::__construct();
	}
