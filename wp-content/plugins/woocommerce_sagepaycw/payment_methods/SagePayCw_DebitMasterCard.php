...
class SagePayCw_DebitMasterCard extends SagePayCw_PaymentMethod
{
	public $machineName = 'debitmastercard';
	public $admin_title = 'Debit MasterCard';
	public $title = 'Debit MasterCard';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_sagepaycw_debitmastercard_icon', 
			SagePayCw_Util::getResourcesUrl('icons/debitmastercard.png')
		);
		parent::__construct();
	}
