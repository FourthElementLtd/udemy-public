...
class SagePayCw_Diners extends SagePayCw_PaymentMethod
{
	public $machineName = 'diners';
	public $admin_title = 'Diners Club';
	public $title = 'Diners Club';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_sagepaycw_diners_icon', 
			SagePayCw_Util::getResourcesUrl('icons/diners.png')
		);
		parent::__construct();
	}
