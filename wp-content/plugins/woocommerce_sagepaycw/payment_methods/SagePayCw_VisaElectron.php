...
class SagePayCw_VisaElectron extends SagePayCw_PaymentMethod
{
	public $machineName = 'visaelectron';
	public $admin_title = 'Visa Electron';
	public $title = 'Visa Electron';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_sagepaycw_visaelectron_icon', 
			SagePayCw_Util::getResourcesUrl('icons/visaelectron.png')
		);
		parent::__construct();
	}
