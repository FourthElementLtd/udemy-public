...
class SagePayCw_DebitVisa extends SagePayCw_PaymentMethod
{
	public $machineName = 'debitvisa';
	public $admin_title = 'Debit Visa';
	public $title = 'Debit Visa';
	...
	public function __construct() {
		$this->icon = apply_filters(
			'woocommerce_sagepaycw_debitvisa_icon', 
			SagePayCw_Util::getResourcesUrl('icons/debitvisa.png')
		);
		parent::__construct();
	}
