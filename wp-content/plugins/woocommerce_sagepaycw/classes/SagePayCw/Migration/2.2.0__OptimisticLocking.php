...
class SagePayCw_Migration_2_2_0 implements Customweb_Database_Migration_IScript {
	...
	public function execute(Customweb_Database_IDriver $driver){
		...
		$tableNameTransaction = $entityManager->getTableNameForEntityByClassName('SagePayCw_Entity_Transaction');
		...
		$tableNameECC = $entityManager->getTableNameForEntityByClassName('SagePayCw_Entity_ExternalCheckoutContext');
		...
		$tableName = $wpdb->prefix . 'woocommerce_sagepaycw_customer_contexts';
		$tableNameNew = $wpdb->prefix . 'woocommerce_sagepaycw_cc';
		...
		$tableNamePCC = $entityManager->getTableNameForEntityByClassName('SagePayCw_Entity_PaymentCustomerContext');
