 ...
 *
 */
class SagePayCw_CartOrderContext extends Customweb_Payment_Authorization_OrderContext_AbstractDeprecated {
	...
	public function getInvoiceItems(){
		return SagePayCw_CartUtil::getInoviceItemsFromCart($this->cart);
	}
	...
	public function getBillingState(){
		if (isset($this->userData['billing_state'])) {
			return SagePayCw_Util::cleanUpStateField($this->userData['billing_state'], $this->getBillingCountryIsoCode());
		}
		else {
			return null;
		}
	...
	public function getShippingState(){
		if ($this->isShipToBilling() || !isset($this->userData['shipping_state'])) {
			...
			return SagePayCw_Util::cleanUpStateField($this->userData['shipping_state'], $this->getShippingCountryIsoCode());
		}
	}
