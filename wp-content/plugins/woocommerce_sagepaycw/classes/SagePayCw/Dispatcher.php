...
class SagePayCw_Dispatcher
{
	...
	public function dispatch() {
		try {
			$request = SagePayCw_ContextRequest::getInstance();
	...
	private function getControllerInstance() {
		...
		$expectedClassName = 'SagePayCw_Controller_' . Customweb_Core_Util_String::ucFirst($this->controllerName);
		$effectiveClass = null;
