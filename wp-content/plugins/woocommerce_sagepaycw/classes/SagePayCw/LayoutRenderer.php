...
class SagePayCw_LayoutRenderer implements Customweb_Mvc_Layout_IRenderer{
	...
	public function render(Customweb_Mvc_Layout_IRenderContext $context) {
		...
		if(!empty($title)) {
			$GLOBALS['woo_sagepaycwTitle'] = $title;
		}
		...
		$GLOBALS['woo_sagepaycwCSS'] = $cssString;		
		...
		$GLOBALS['woo_sagepaycwJS'] = $jsString;
		$GLOBALS['woo_sagepaycwContent'] = $context->getMainContent();
