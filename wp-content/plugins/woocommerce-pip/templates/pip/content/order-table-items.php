 ...
 * @since 3.0.0
 */
$coupons = $document->get_coupons_used();
					...
					<tbody class="order-table-body">
						...
						<?php endforeach; ?>
                    <?php
                    //add order line for any free products as part of promotion
                    if ($coupons[0] == 'freegulper') {
                    $wght = get_post_meta(25749,'_weight',true);
                        if ($wght) {
                            $showWght = '<td class="weight">'.$wght.'</td>';
                        }
                    ?>
                        <tr class="row item">
                            <td class="sku"><span class="sku">GWB03</span></td>
                            <td class="product"><span class="product-variation product product-name">Gulper (Black)</span><br/><sub>Please see https://fourthelement.com/terms-and-conditions for free product terms and conditions</sub></td>
                            <td class="quantity"><span class="quantity">1</span></td>
                            <?php if ($document->name == 'Packing List') { echo $showWght; } ?>
                            <td class="price"><span class="price"><span class="woocommerce-Price-amount amount"><bdi><span class="woocommerce-Price-currencySymbol">FREE</bdi></span></span>												</td>
                            <td class="id"></td></tr>
                    <?php } ?>
					</tbody>
					<?php
