...
class WC_PIP_Orders_Admin {
	...
	public function add_order_status_column_content( $column, $order_id ) {
		...
		// hidden content that will be injected as order button actions tooltip content in JS ('wc_actions' is for WC 3.3+)
		} elseif ( 'order_actions' === $column || 'wc_actions' === $column ) {

			?>
			<div id="wc-pip-tooltip-order-actions-<?php echo $order_id; ?>"
