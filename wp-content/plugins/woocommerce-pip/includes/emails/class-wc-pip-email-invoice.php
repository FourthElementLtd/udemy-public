...
class WC_PIP_Email_Invoice extends WC_Email {
	...
	public function trigger( $object ) {
		...
		$billing_email = SV_WC_Order_Compatibility::get_prop( $object->order, 'billing_email' );
		...
		$order_timestamp = ( $date_created = SV_WC_Order_Compatibility::get_date_created( $object->order ) ) ? $date_created->getOffsetTimestamp() : 0;
